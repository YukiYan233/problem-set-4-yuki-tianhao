...
# texas_zipcodes = zipcodes[zipcodes['ZCTA5CE10'].str.startswith(('75', '76', '77', '78'))]

# # Load POS data for 2016
# pos2016 = pd.read_csv("pos2016.csv")  # Replace with actual path

# # Group by ZIP code and count hospitals
# hospital_counts = pos2016.groupby('ZIP_CD').size().reset_index(name='hospital_count')

# # Merge hospital counts with Texas zip code shapefile
# texas_zipcodes = texas_zipcodes.merge(hospital_counts, left_on='ZCTA5CE10', right_on='ZIP_CD', how='left')
